...
import { componentsData, libraryInfo } from './components-data.js';
/**
 ...
 */
function formatComponentBrief(component) {
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    switch (name) {
        ...
        case 'get_component': {
            ...
            const component = componentsData.find((c) => c.name.toLowerCase() === componentName.toLowerCase());
            if (!component) {
